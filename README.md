...
- 7B에서 시도한 후보는 모두 기준을 넘지 못했다. 14B는 크게 올랐지만 미리 정한 채택 조건(호출당 시간 3배 이하, 정답에 없는 쓰기가 늘지 않음)에 걸려 채택하지 않았다. 그래서 **판정은 "개선 없음"**이고, 시험용 40과제의 기준 수치는 pass^1 16.2% [8.8, 24.4], pass^4 2.5%다
